 ...
 * @author Jesús
 */
public class Graphs1 extends javax.swing.JFrame {
    ...
    public Graphs1(Interface principal) {
        initComponents();
    ...
    public void setRenCol()
    {
        canvas.setRenCol(jRBRe.isSelected());
    }
    /**
    ...
    private void initComponents() {
        ...
        jRBRe = new javax.swing.JRadioButton();
        jTFnoRen = new javax.swing.JTextField();
        ...
        title.setText("Grafico Renglon-Columna");
        ...
        jRBRe.setSelected(true);
        jRBRe.setText("jRadioButton1");
        jRBRe.setFocusable(false);
        jRBRe.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jRBRe.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        toolBar.add(jRBRe);

        jTFnoRen.setText("10");
        toolBar.add(jTFnoRen);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setNoRen(Integer.parseInt(jTFnoRen.getText()));
        setRenCol();
        canvas.setHisVF(false);
        canvas.repaint();
    ...
    private javax.swing.JRadioButton jRBRe;
    private javax.swing.JTextField jTFnoRen;
